...
import { Table, Input, Space, Menu, Dropdown, Button, Tag, Select, Checkbox, Divider } from "antd";
...
const filteredProductMenuItem = ['Procurement', 'App Kube', 'HRMS', 'Xformation', 'EMS'].filter(item =>
  item.toLowerCase().includes(selectSearchProducrDropdown.toLowerCase()));

const filteredAssigneetoMenuItem = ['Floyd', 'Mob', 'Angela Moss'].filter(item =>
...
const columns = [
    ...
    },
    {
      ...
      <Menu.Item>
        ...
        /><CloseOutlined onClick={handleProductClearButton}  style={{marginLeft:"10px", fontSize:"10px", color:"red"}} />
      </Menu.Item>
      ...
      <Menu.Item>
        <Input
          ...
          style={{ marginBottom: '10px', width:"100px" }}
        /><CloseOutlined onClick={handleAssigneetoClearButton}  style={{marginLeft:"10px", fontSize:"10px", color:"red"}} />
      </Menu.Item>
      ...
      <Menu.Item>
        <Input
          ...
          style={{ marginBottom: '10px', width:"100px" }}
        /><CloseOutlined onClick={handleModuleClearButton}  style={{marginLeft:"10px", fontSize:"10px", color:"red"}} />
      </Menu.Item>
